...
You need to get this proof to someone who matters. But how?`,
    choices: [
      ...
      {
        id: 'hide-proof',
        label: 'Hide the proof in a secret location—retrieve it later',
        nextSceneId: 'echoes-brine',
        stateEffects: { hasProof: false, trustKael: 5 },
      },
      {
        id: 'make-copy',
        label: 'Try to make a copy before ascending—spread the risk',
        nextSceneId: 'echoes-brine',
        stateEffects: { hasProof: true, trustKael: 8, publicKnowsTruth: true },
      },
    ],
  },
  {
...
You can show them the proof now, or wait until you've climbed higher.`,
    choices: [
      ...
      {
        id: 'seek-allies',
        label: 'Ask Elder Mara to gather trusted allies—plan carefully',
        nextSceneId: 'gate-glass',
        stateEffects: { brinefolkRallyPotential: 15, trustKael: 18, hasProof: true },
      },
      {
        id: 'trade-info',
        label: 'Share partial information—test who can be trusted',
        nextSceneId: 'gate-glass',
        stateEffects: { trustKael: 12, brinefolkRallyPotential: 10 },
      },
      {
        id: 'request-help',
        label: 'Ask for help reaching the upper levels',
        nextSceneId: 'gate-glass',
        stateEffects: { trustKael: 15, hasProof: true },
      },
    ],
  },
  {
...
But Lyra steps forward, her voice cutting through the tension. "Wait. I want to hear what he has to say."`,
    choices: [
      ...
      {
        id: 'wait-opportunity',
        label: 'Wait and observe—find the right moment to approach',
        nextSceneId: 'sky-garden',
        stateEffects: { trustLyra: 8, trustKael: 5 },
      },
      {
        id: 'create-distraction',
        label: 'Create a distraction to get past the guard',
        nextSceneId: 'sky-garden',
        stateEffects: { trustLyra: 10, trustKael: -5 },
      },
      {
        id: 'speak-quietly',
        label: 'Speak quietly to Lyra—avoid drawing attention',
        nextSceneId: 'sky-garden',
        stateEffects: { trustLyra: 12, hasProof: true },
      },
    ],
  },
  {
...
The air between you is charged with possibility. You could trust her. Or you could see this as a trap.`,
    choices: [
      ...
      {
        id: 'share-story',
        label: 'Share your story—make her understand the cost of inaction',
        nextSceneId: 'above-veil',
        stateEffects: { trustLyra: 18, trustKael: 10 },
      },
      {
        id: 'ask-questions',
        label: 'Ask about her family—understand the system from within',
        nextSceneId: 'above-veil',
        stateEffects: { trustLyra: 12, hasProof: true },
      },
      {
        id: 'propose-alliance',
        label: 'Propose working together—a partnership for change',
        nextSceneId: 'above-veil',
        stateEffects: { trustLyra: 20, trustKael: 8 },
      },
    ],
  },
  {
...
The choice is yours—and hers. How do you want to proceed?`,
    choices: [
      ...
      {
        id: 'negotiate-terms',
        label: 'Negotiate terms—what will she risk for this?',
        nextSceneId: 'summit-confrontation',
        stateEffects: { trustLyra: 8, trustKael: 5 },
      },
      {
        id: 'give-her-choice',
        label: 'Give her the choice—let her decide without pressure',
        nextSceneId: 'summit-confrontation',
        stateEffects: { trustLyra: 22, hasProof: true },
      },
      {
        id: 'plan-together',
        label: 'Plan the approach together—coordinate your strategy',
        nextSceneId: 'summit-confrontation',
        stateEffects: { trustLyra: 18, trustKael: 10, hasProof: true },
      },
    ],
  },
  {
